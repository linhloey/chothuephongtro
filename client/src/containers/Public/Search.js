...
const Search = () => {
  return (
    <div className='p-[10px] w-3/5 my-3 bg-[#febb02] rounded-lg flex-col lg:flex-row flex items-center justify-around gap-2'>
        <SearchItem IconBefore={<MdOutlineHouseSiding />} IconAfter={<BsChevronRight color='black' />} fontWeight text='Phòng trọ, nhà trọ' />
        ...
        <button 
        type='button'
        className='outline-none py-2 px-4 w-full bg-secondary1 text-[13px] flex items-center justify-center gap-2 text-white font-medium'
        >
            <FiSearch />
            Tìm kiếm
        </button>
